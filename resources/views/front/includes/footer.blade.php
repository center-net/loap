                                    ...
                                    <div id="social_block">
                                        <div class="social">
                                            <ul class="list-inline mb-0 justify-content-end">
                                                <li class="list-inline-item mb-0"><a href="{{$setting->facebook}}" target="_blank"><i class="zmdi zmdi-facebook"></i></a></li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 align-items-center justify-content-md-start justify-content-sm-center d-flex pb-xs-max-20 flex-center">
                    <span>
            Copyright © 2018 {{$setting->translate(app()->getLocale())->title}} 
          </span>
                </div>
