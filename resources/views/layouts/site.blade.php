...
<head>
    ...
    <meta name="description" content="{{$setting->translate(app()->getLocale())->title}}">
    <meta name="keywords" content="{{$setting->translate(app()->getLocale())->title}}">
    ...
    @if(app()->getLocale() == 'ar')
    <link rel="stylesheet" href="https://demo.bestprestashoptheme.com/savemart/themes/vinova_savemart/assets/cache/theme-2dfe1424.css" type="text/css" media="all">
    @else
    ...
    <style type="text/css">
        #main-site {background-color: #ffffff;}@media (min-width: 1200px) {.container {width: 1200px;}#header .container {width: 1200px;}.footer .container {width: 1200px;}#index .container {width: 1200px;}}#popup-subscribe .modal-dialog .modal-content {background-image: url({{asset($setting->logo)}});}
    </style>
